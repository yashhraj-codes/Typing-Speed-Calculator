...
opening_label.grid(row=0, column=0, columnspan=2, padx=10, pady=10)
opening_label.grid()
...
# LITERATURE WORDS FETCH SUB- NCTION #
...
lit = Button (topic_window,
                    ...
                    fg="red",
                    bg="orange",
                    highlightbackground="#000000", command=lit)
lit.grid(row=1, column=0)

 

# SPORTS WORDS FETCH SUB
...
def time():
    ...
    global timeleft, score, miss, wpm, words
...
def sliding_words():
    ...
    count += 1
    count.configure(text=words_slide)
